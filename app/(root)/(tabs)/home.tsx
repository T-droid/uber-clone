        ...
        renderItem={({ item }) => (
          <RideCard
            ride={{
              ...
              fare_price: parseFloat(item.fare_price),
            }}
          />
        )}
        className='px-5'
        ...
        ListHeaderComponent={() => (
          <>
            <View className='flex flex-row items-center justify-between my-5'>
              <Text className='text-2xl capitalize font-JakartaExtraBold'>Welcome, {user?.user?.firstName || user.user?.emailAddresses[0].emailAddress.split("@")[0]} 👋</Text>
              <TouchableOpacity
