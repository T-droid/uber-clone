    ...
    <ScrollView className='flex-1 bg-white'>
      <View className='flex-1 bg-white'>
        ...
        <View className='p-5'>
          ...
          {/* OAuth */}
          <OAuth />
          <Link href="/(auth)/sign-in" className='text-lg text-center text-general-200 mt-9'>
        ...
        <ReactNativeModal isVisible={verification.state === 'success'}>
          <View className='bg-white px-7 py-9 rounded-2xl min-h-[300px]'>
            ...
            <Text className='text-base text-gray-400 font-Jakarta text-center mt-2'>You have succesfully verified your account</Text>
            <CustomButton
              title='Browse Home'
