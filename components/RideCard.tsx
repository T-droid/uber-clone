...
const RideCard = ({ ride: {
    destination_longitude, destination_latitude, destination_address, origin_longitude, origin_latitude, origin_address, ride_time, fare_price, payment_status, driver_id, user_id, created_at, driver
} } : {ride: Ride}) => {
  return (
